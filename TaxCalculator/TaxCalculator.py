...
class tax_calculator:
  def __init__(self):
    ...
    self.result_label.grid(row=3,column=0,**self.padding)
    self.result_entry=ctk.CTkEntry(self.window)
    self.result_entry.insert(0,'0') #assign for default value
    self.result_entry.grid(row=3,column=1,**self.padding)
